<template>
  <div class="relative py-12 bg-repeat bg-[length:240px] bg-tart-500 bg-hero-pattern">
    ...
    <img src="/img/portrait-illustration.png" alt="Portrait illustration of me, Christopher Kennedy" class="absolute bottom-0 z-0 h-full -right-24 sm:right-0 opacity-60 sm:opacity-80 md:opacity-100">
  </div>
</template>